...
import 'package:e_book_okba_store/Pages/sub_categories_widget.dart';
import 'package:e_book_okba_store/Components/BookTile.dart';
                            ...
                            builder: (context,
                              ...
                              return Column(
                                children: books
                                        ...
                                        .toList() ??
                                    [
                                      // Handle the case where books are null or empty.
                                      Text('لا توجد كتب في هذا القسم'),
                                    ],
                              );
                            },
                          );
